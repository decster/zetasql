...
class ParseTreeVisitor {
 public:
  ...
  virtual void visitASTFilterFieldsExpression(const ASTFilterFieldsExpression* node, void* data) = 0;
...
class DefaultParseTreeVisitor : public ParseTreeVisitor {
 public:
  ...
  void visitASTFilterFieldsExpression(const ASTFilterFieldsExpression* node, void* data) override {
    defaultVisit(node, data);
  }
...
class NonRecursiveParseTreeVisitor {
 public:
  ...
  virtual absl::StatusOr<VisitResult> visitASTFilterFieldsExpression(const ASTFilterFieldsExpression* node) {return defaultVisit(node);};
